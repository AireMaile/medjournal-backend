...
export async function createLog(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
  try {
...
export async function updateLog(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
  try {
